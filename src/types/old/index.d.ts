...
// // export type RegisteredApp = "Spent";
// export type UBDevConfig = Record<RegisteredApp, AppConfig> & {
...
// // const RegApp = ["Spent","TrackRev"] as const;

// // type RegApps = typeof RegApp[number];
import { registeredApps } from "@/config";
